            ...
            <div className="flex gap-3">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3.5 py-2.5 text-sm text-white placeholder:text-neutral-600 focus:border-[#eab308] focus:outline-none focus:ring-1 focus:ring-[#eab308] disabled:opacity-50"
                />
              </div>
              <div className="flex-1">
                <label className="block text-xs font-medium text-neutral-400 mb-1.5">
                ...
                <select
                  ...
                  disabled={status === 'loading'}
                  className="w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3.5 py-2.5 text-sm text-white focus:border-[#eab308] focus:outline-none focus:ring-1 focus:ring-[#eab308] disabled:opacity-50"
                >
                  {FOCUS_PRESETS.map(p => (
                ...
                {focusPreset === 'other' && (
                  <input
                    ...
                    disabled={status === 'loading'}
                    autoFocus
                    className="mt-2 w-full rounded-lg border border-neutral-800 bg-neutral-900 px-3.5 py-2.5 text-sm text-white placeholder:text-neutral-600 focus:border-[#eab308] focus:outline-none focus:ring-1 focus:ring-[#eab308] disabled:opacity-50"
                  />
                )}
              </div>
            </div>
            ...
            <div className="flex items-end gap-4">
              <div className="flex-1">
                ...
                <input
                  ...
                  disabled={status === 'loading'}
                  className="w-full accent-[#eab308] disabled:opacity-50 cursor-pointer"
                />
              ...
              <Button
                ...
                className="h-10 px-6 bg-[#eab308] hover:bg-[#ca8a04] text-black shrink-0 mb-5 disabled:opacity-40"
              >
        ...
        {status === 'done' && result && (
          <div className="rounded-xl border border-neutral-800 bg-neutral-950 px-5 py-4 mb-8 flex flex-col sm:flex-row sm:items-center gap-4">
            <div className="flex items-center gap-2.5 shrink-0">
              <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-[#eab308]/10 border border-[#eab308]/20">
            ...
            <div className="flex items-center gap-2 sm:ml-auto flex-wrap">
              {([
                ...
                <button
                  key={label}
                  onClick={action}
                  className="flex items-center gap-2 rounded-lg border border-neutral-700 bg-neutral-900 px-4 py-2 text-sm text-white hover:border-[#eab308] hover:bg-[#eab308]/10 hover:text-[#eab308] transition-colors"
                >
